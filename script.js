const levels = [
    ...
    },
    {
        ...
        questions: [
            ...
            {
                question: "用人单位未及时足额支付劳动报酬的，至少应加付劳动者的赔偿金为欠付金额的多少？",
                options: ["20%", "50%", "80%", "100%"],
                correctAnswer: 1
            },
            {
                question: "劳动者在试用期内提出解除劳动合同，需要提前多久通知用人单位？",
                options: ["3天", "不需要提前通知", "7天", "30天"],
                correctAnswer: 0
            },
            {
    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                options: ["100 元", "500 元", " 100-500 元", "至少 500 元"],
                correctAnswer: 2
            }
        ]
    },
    {
        ...
        questions: [
            {
                question: "甲公司与员工乙在劳动合同中约定 “因公司业务调整，公司可以随时调整乙的工作岗位，乙应无条件服从”。后甲公司因业务转型将乙从技术部门调到销售部门，乙以专业不对口为由拒绝。关于此争议，下列说法正确的是？",
                options: ["甲公司有权根据约定调整乙的工作岗位，乙必须服从", "该约定因排除了乙协商变更劳动合同的权利而无效", " 甲公司调整乙工作岗位未与乙协商一致，应承担违约责任", "乙拒绝调岗合理，甲公司应恢复乙原岗位工作"],
                correctAnswer: 1
            },
            {
                question: "劳动者丙在某公司连续工作满 10 年，且距离法定退休年龄不足 10 年，现公司因经营困难进行经济性裁员。下列关于丙的说法正确的是？",
                options: ["公司不得裁减丙，因为丙属于优先留用人员", "公司可以裁减丙，但应提前 30 日向工会或者全体职工说明情况", "公司裁减丙后，若在 6 个月内重新招用人员，应当通知丙并在同等条件下优先招用丙", "公司裁减丙需经过丙本人同意，否则不得裁减"],
                correctAnswer: 0
            },
            {
